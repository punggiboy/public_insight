...
const data = [
  { name: "분류 1", value: 928, color: "#FFA500" },
  { name: "분류 2", value: 592, color: "#FF8C00" },
  { name: "분류 3", value: 428, color: "#FFD700" },
  { name: "분류 4", value: 412, color: "#FFDAB9" },
  { name: "분류 5", value: 266, color: "#FFEFD5" },
  { name: "기타", value: 122, color: "#FFF5E6" },
]

interface CultureyDepartmentChartProps {
  onCategorySelect: (category: string) => void
  selectedCategory: string | null
}

// 컴포넌트를 memo로 감싸서 불필요한 리렌더링 방지
const CultureyDepartmentChart = memo(({ onCategorySelect, selectedCategory }: CultureyDepartmentChartProps) => {
  ...
  return (
    <div className="pt-2 px-4 flex justify-center">
      <div className="w-full max-w-2xl">
        <h2 className="text-2xl font-bold text-center mb-4 text-[#FFA500]">문화체육관광부</h2>
...
// 컴포넌트 표시 이름 설정
CultureyDepartmentChart.displayName = "CultureyDepartmentChart"

export default CultureyDepartmentChart
