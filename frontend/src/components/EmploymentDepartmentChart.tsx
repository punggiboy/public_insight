...
const data = [
  { name: "분류 1", value: 928, color: "#8B4513" },
  { name: "분류 2", value: 592, color: "#A0522D" },
  { name: "분류 3", value: 428, color: "#B8860B" },
  { name: "분류 4", value: 412, color: "#DEB887" },
  { name: "분류 5", value: 266, color: "#D2B48C" },
  { name: "기타", value: 122, color: "#FFF5E6" },
]

interface EmploymentDepartmentChartProps {
  onCategorySelect: (category: string) => void
  selectedCategory: string | null
}

// 컴포넌트를 memo로 감싸서 불필요한 리렌더링 방지
const EmploymentDepartmentChart = memo(({ onCategorySelect, selectedCategory }: EmploymentDepartmentChartProps) => {
  ...
  return (
    <div className="pt-2 px-4 flex justify-center">
      <div className="w-full max-w-2xl">
        <h2 className="text-2xl font-bold text-center mb-4 text-[#8B4513]">고용노동부</h2>
...
// 컴포넌트 표시 이름 설정
EmploymentDepartmentChart.displayName = "EmploymentDepartmentChart"

export default EmploymentDepartmentChart
